...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Password_divLoginHelpLink'))
...
WebUI.waitForElementPresent(findTestObject('Page_OrangeHRM/a_Logout'), 10)
